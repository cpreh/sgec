...
extern "C" sgec_renderer_texture_size
sgec_texture_part_width(struct sgec_texture_part const *const _texture)
{
  return _texture->size().w();
}

extern "C" sgec_renderer_texture_size
sgec_texture_part_height(struct sgec_texture_part const *const _texture)
{
