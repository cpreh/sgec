...
sgec::impl::input::cursor::translate_button_state(sge::input::cursor::button_pressed const _pressed)
{
  return _pressed.get() ? sgec_input_cursor_button_state_pressed
